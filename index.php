...
<body>
    <div class="brand"> <img src="#" width="170" heigth="160" alt="" srcset=""> Entregas Perez</div>
    ...
    <div class="container">
                    ...
                    <div id="carousel-example-generic" class="carousel slide">
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                <img class="img-responsive img-full" src="img/XDDC.jfif" alt="">
                            </div>
                            <div class="item">
                                <img class="img-responsive img-full" src="img/XDDC.jfif" alt="">
                            </div>
		...
		<?php 
			$conn = mysqli_connect("localhost","id22414550_user","Manuelpa97@","id22414550_entregas");
